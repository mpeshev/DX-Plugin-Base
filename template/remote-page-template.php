<div class="wrap">
	...
	<h2><?php _e( "Remote plugin page", DXP_TD ); ?></h2>
	
	<p><?php _e( "Performing side activities - AJAX and HTTP fetch", DXP_TD ); ?></p>
	...
	<h3><?php _e( 'Store a Database option with AJAX', DXP_TD ); ?></h3>
	<form id="dx-plugin-base-ajax-form" action="options.php" method="POST">
			...
			<input type="submit" value="<?php _e( "Save with AJAX", DXP_TD ); ?>" />
	</form> <!-- end of #dx-plugin-base-ajax-form -->
	
	<h3><?php _e( 'Fetch a title from URL with HTTP call through AJAX', DXP_TD ); ?></h3>
	<form id="dx-plugin-base-http-form" action="options.php" method="POST">
			...
			<input type="submit" value="<?php _e( "Fetch URL title with AJAX", DXP_TD ); ?>" />
